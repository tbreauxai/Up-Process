export const initialLeadDetails = {
  names: '', phoneNumber: '', hasLicense: false, vehicleOfInterest: '', 
  stockNumber: '', buyingReason: '', phoneOwnerStatus: '', currentDriver: '', 
  wantsToTrade: '', hasAppraised: '', appraisalTime: '', tradeValueObjection: '',
  futurePlan: '', apptStatus: '', apptDate: '', apptTime: '',
  drivenBefore: '', reasonForVisit: '', tradingIn: '', occupation: '', 
  local: '', competition: '', softClose: '',
  softCloseStopping: '', softCloseTimeframe: '', softCloseFollowUp: '',
  phoneNeeds: '', phoneBudget: ''
};
